                            ...
                            <div class="form-main">
                                ...
                                <div class="form-main-item">
                                    ...
                                    <asp:CustomValidator ID="CustomValidator1" runat="server" 
                                        ControlToValidate="ddl_sex" OnServerValidate="SexCustomValidator" 
                                        ErrorMessage="请选择性别"></asp:CustomValidator>
                                </div>
                            </div>
                            <div class="registerBtn-div">
                                <asp:Button CssClass="registerBtn" ID="Button1" runat="server" Text="注册"
                                    OnClick="RegisterUser" UseSubmitBehavior="False" />
                            </div>
